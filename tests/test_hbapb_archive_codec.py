...
def signed_bundle(n, indices, key, *, seed_base, seed):
    ...
    hampb_archive = archive_of_size(n, key, seed_base=seed_base)
    return signed_hbapb(hampb_archive, indices, key, seed=seed)
...
def make_archive(items, key, *, seed=31300):
    from thresholdsign import hbapba_message
